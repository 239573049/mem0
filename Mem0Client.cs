...
/// <summary>
/// Mem0 .NET 客户端 - 基于Python版本MemoryClient的完整实现
/// </summary>
public class Mem0Client : IDisposable
{
        ...
        HttpClient? httpClient = null)
    {
        ...
        // 验证API密钥
        ValidateApiKey().GetAwaiter().GetResult();
    }
    ...
    private async Task ValidateApiKey()
    {
        try
        {
            ...
            var response = await _httpClient.GetAsync($"v1/ping/?{BuildQueryString(queryParams)}");
            await EnsureSuccessStatusCodeAsync(response);

            var content = await response.Content.ReadAsStringAsync();
            var data = JsonSerializer.Deserialize<PingResponse>(content, _jsonOptions);
        ...
        {
            throw new Mem0ApiException($"API key validation failed: {ex.Message}", ex);
        }
    }
    ...
    /// 添加新记忆
    /// </summary>
    public async Task<AddMemoryResponse> AddAsync(List<Message> messages, 
        string? userId = null,
        string? agentId = null,
        string? appId = null,
        string? runId = null,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await _httpClient.PostAsync("v1/memories/", content, cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);

        var responseContent = await response.Content.ReadAsStringAsync(cancellationToken);
        return JsonSerializer.Deserialize<AddMemoryResponse>(responseContent, _jsonOptions) ?? new AddMemoryResponse();
    }
    ...
    {
        var queryParams = PrepareParams(new Dictionary<string, object>());
        var response = await _httpClient.GetAsync($"v1/memories/{Uri.EscapeDataString(memoryId)}/?{BuildQueryString(queryParams)}", cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
    ...
    /// 获取所有记忆
    /// </summary>
    public async Task<GetAllMemoriesResponse> GetAllAsync(string version = "v1",
        string? userId = null,
        string? agentId = null,
        string? appId = null,
        string? runId = null,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (version == "v1")
        {
            response = await _httpClient.GetAsync($"{version}/memories/?{BuildQueryString(preparedParams)}", cancellationToken);
        }
        else if (version == "v2")
        {
        ...
        await EnsureSuccessStatusCodeAsync(response);
        var responseContent = await response.Content.ReadAsStringAsync(cancellationToken);
        return JsonSerializer.Deserialize<GetAllMemoriesResponse>(responseContent, _jsonOptions) ?? new GetAllMemoriesResponse();
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await _httpClient.PutAsync($"v1/memories/{Uri.EscapeDataString(memoryId)}/?{BuildQueryString(queryParams)}", content, cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
    ...
    {
        var queryParams = PrepareParams(new Dictionary<string, object>());
        var response = await _httpClient.DeleteAsync($"v1/memories/{Uri.EscapeDataString(memoryId)}/?{BuildQueryString(queryParams)}", cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await _httpClient.DeleteAsync($"v1/memories/?{BuildQueryString(queryParams)}", cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
    ...
    {
        var queryParams = PrepareParams(new Dictionary<string, object>());
        var response = await _httpClient.GetAsync($"v1/memories/{Uri.EscapeDataString(memoryId)}/history/?{BuildQueryString(queryParams)}", cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
    ...
    {
        var queryParams = PrepareParams(new Dictionary<string, object>());
        var response = await _httpClient.GetAsync($"v1/entities/?{BuildQueryString(queryParams)}", cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var response = await _httpClient.DeleteAsync($"v2/entities/{entity.Type}/{Uri.EscapeDataString(entity.Name)}/?{BuildQueryString(queryParams)}", cancellationToken);
            await EnsureSuccessStatusCodeAsync(response);
        }
    ...
    /// 批量更新记忆
    /// </summary>
    public async Task<MessageResponse> BatchUpdateAsync(List<BatchMemoryUpdate> memories, CancellationToken cancellationToken = default)
    {
        var payload = new { memories };
        var json = JsonSerializer.Serialize(payload, _jsonOptions);
        var content = new StringContent(json, Encoding.UTF8, "application/json");

        var response = await _httpClient.PutAsync("v1/batch/", content, cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
    ...
    /// 批量删除记忆
    /// </summary>
    public async Task<MessageResponse> BatchDeleteAsync(List<BatchMemoryDelete> memories, CancellationToken cancellationToken = default)
    {
        var payload = new { memories };
        var json = JsonSerializer.Serialize(payload, _jsonOptions);
        var content = new StringContent(json, Encoding.UTF8, "application/json");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await _httpClient.PostAsync("v1/feedback/", content, cancellationToken);
        await EnsureSuccessStatusCodeAsync(response);
